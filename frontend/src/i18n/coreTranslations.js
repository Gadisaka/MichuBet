...
export const translations = Object.freeze({
  en: Object.freeze({
    ...
    withdraw: Object.freeze({
      ...
      shopTitle: "Shop",
      shopHint: "Collect cash at a cashier.",
      onlineTitle: "Online",
      onlineHint: "Send to your bank or wallet.",
      ...
      winningsOnly: "Only winnings can be withdrawn.",
      getCode: "Get withdrawal code",
      generatingCode: "Generating code…",
      codeTitle: "Your one-time code",
      copyCode: "Copy code",
      expiresAt: "Unused codes expire after",
      invalidAmount: "Enter a valid amount.",
      exceedsBalance: "Amount exceeds your balance.",
      exceedsWithdrawable: "Withdrawable balance is",
      somethingWrong: "Something went wrong.",
      min: "Minimum withdrawal is",
      max: "Maximum withdrawal is",
      bankType: "Bank",
      walletType: "Wallet",
  ...
  am: Object.freeze({
    ...
    withdraw: Object.freeze({
      ...
      shopTitle: "ሱቅ",
      shopHint: "ከካሸር በጥሬ ገንዘብ ይቀበሉ።",
      onlineTitle: "ኦንላይን",
      onlineHint: "ወደ ባንክ ወይም ዋሌት ይላኩ።",
      ...
      balance: "ባላንስዎ",
      withdrawable: "የሚወጣ",
      winningsOnly: "የሚወጣው የማሸነፊያ ገንዘብ ብቻ ነው።",
      getCode: "የማውጫ ኮድ ያግኙ",
      generatingCode: "ኮድ በመፍጠር ላይ…",
      codeTitle: "አንድ ጊዜ የሚያገለግል ኮድዎ",
      copyCode: "ኮድ ቅዳ",
      expiresAt: "ያልተጠቀሙ ኮዶች የሚያልቁበት",
      invalidAmount: "ትክክለኛ መጠን ያስገቡ።",
      exceedsBalance: "መጠኑ ከባላንስዎ ይበልጣል።",
      exceedsWithdrawable: "የሚወጣ ባላንስ",
      somethingWrong: "ችግር ተፈጥሯል።",
      min: "ዝቅተኛ ማውጣት",
      max: "ከፍተኛ ማውጣት",
      bankType: "ባንክ",
      walletType: "ዋሌት",
