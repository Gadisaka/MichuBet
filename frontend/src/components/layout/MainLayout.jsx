function MainLayout({ left, center, right }) {
  return (
    <div className="grid items-start gap-2.5 px-2 pb-2 pt-1 sm:px-3 xl:grid-cols-[220px_minmax(0,1fr)_300px] lg:grid-cols-[190px_minmax(0,1fr)_260px] max-lg:grid-cols-1">
