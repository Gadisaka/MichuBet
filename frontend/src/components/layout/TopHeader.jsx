...
function TopHeader() {
  ...
  return (
    <>
      <header className="flex min-w-0 items-center gap-3 overflow-visible border-b border-white/10 bg-[#000000] px-2.5 py-1.5 max-lg:gap-2 max-lg:px-2">
        <Link
          to="/"
          className="mr-auto inline-flex shrink-0 flex-col justify-center rounded bg-[#000000] px-1.5 py-1 leading-none no-underline sm:px-2"
        >
        ...
        {isLoggedIn ? (
          <div className="relative flex items-center gap-2 text-sm text-[#ffffff] max-lg:gap-1.5">
            ...
            <Link
              ...
              className="inline-flex min-h-[30px] min-w-[30px] cursor-pointer items-center justify-center rounded-2xl border-0 bg-(--sb-accent-fill) px-3.5 text-xs font-bold text-[#000000] no-underline hover:bg-(--sb-accent-fill-hover) max-lg:size-8 max-lg:min-h-0 max-lg:min-w-0 max-lg:rounded-full max-lg:px-0"
            >
              <AppIcon
                name="banknote"
                size={18}
            ...
            >
              ...
              {unreadCount > 0 ? (
                <span
                  className="absolute right-0.5 top-0.5 size-2 rounded-full bg-red-500 ring-2 ring-[#000000]"
                  aria-hidden
                />
              ) : null}
            </button>
            ...
            <button
              ...
              className="inline-flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-[#111111] text-[rgba(255,255,255,0.72)]"
            >
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/login"
              className="flex h-[30px] items-center rounded-[14px] bg-[#111111] px-3 text-xs font-extrabold text-[#ffffff] no-underline hover:bg-[#1a1a1a]"
            >
              {t("header.login")}
            </Link>
            <Link
              to="/register"
              className="flex h-[30px] items-center rounded-[14px] border-0 bg-(--sb-accent-fill) px-3 text-xs font-extrabold text-[#000000] no-underline hover:bg-(--sb-accent-fill-hover)"
            >
              {t("header.register")}
            </Link>
          </div>
        ...
        <div className="flex shrink-0 items-center gap-1.5 max-lg:gap-1">
          ...
          <div className="relative z-20 shrink-0" ref={langMenuRef}>
            <button
              ...
              className="inline-flex h-8 cursor-pointer items-center gap-1 rounded-full bg-[#111111] py-0.5 pl-1 pr-1.5 max-lg:h-7"
              title={
            ...
            {langMenuOpen ? (
              <ul
                ...
                className="absolute right-0 top-[calc(100%+6px)] z-50 min-w-[3.25rem] overflow-hidden rounded-xl bg-[#111111] py-1 shadow-[0_12px_32px_-8px_rgba(0,0,0,0.55)]"
              >
                <li role="none">
                  <button
                    type="button"
