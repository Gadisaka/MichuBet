...
function TopHeader() {
  ...
  return (
    <>
      <header className="flex min-w-0 items-center gap-3 overflow-visible border-b border-[#1b2842] bg-[#0a1122] px-2.5 py-1.5 max-lg:gap-2 max-lg:px-2">
        <Link
          to="/"
          className="mr-auto inline-flex shrink-0 flex-col justify-center rounded bg-[#081025] px-1.5 py-1 leading-none no-underline sm:px-2"
        >
        ...
        {isLoggedIn ? (
          <div className="relative flex items-center gap-2 text-sm text-[#d9e1f5] max-lg:gap-1.5">
            <div className="mr-1 flex flex-col items-end leading-[1.12] max-lg:mr-0">
              ...
              <small className="text-[10px] font-bold text-[#7f8ea9]">
                {displayName}
              </small>
            </div>
            <Link
              ...
              className="inline-flex min-h-[30px] min-w-[30px] cursor-pointer items-center justify-center rounded-2xl border-0 bg-(--sb-accent-fill) px-3.5 text-xs font-bold text-[#101012] no-underline hover:bg-(--sb-accent-fill-hover) max-lg:size-8 max-lg:min-h-0 max-lg:min-w-0 max-lg:rounded-full max-lg:px-0"
            >
              <AppIcon
                name="banknote"
                size={18}
                strokeWidth={2.2}
                className="text-[#101012] lg:hidden"
              />
            ...
            <button
              ...
              className="relative inline-flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-[#0c1730] text-[#9eb1d4] hover:bg-[#101a33] hover:text-white max-lg:hidden"
            >
              <AppIcon name="bell" size={16} />
              {unreadCount > 0 ? (
                <span
                  className="absolute right-0.5 top-0.5 size-2 rounded-full bg-red-500 ring-2 ring-[#0c1730]"
                  aria-hidden
                />
              ) : null}
            </button>
            ...
            <button
              ...
              className="inline-flex h-7 w-7 cursor-pointer items-center justify-center rounded-full border border-[#1f2a40] bg-[#0b1326] text-[#a4b2d1]"
            >
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/login"
              className="flex h-[30px] items-center rounded-[14px] border border-[#1f2a40] bg-[#0b1326] px-3 text-xs font-extrabold text-[#cad4ed] no-underline hover:bg-[#111a2f]"
            >
              {t("header.login")}
            </Link>
            <Link
              to="/register"
              className="flex h-[30px] items-center rounded-[14px] border-0 bg-(--sb-accent-fill) px-3 text-xs font-extrabold text-[#101012] no-underline hover:bg-(--sb-accent-fill-hover)"
            >
              {t("header.register")}
            </Link>
          </div>
        ...
        <div className="flex shrink-0 items-center gap-1.5 max-lg:gap-1">
          {telegramCta ? (
            <a
              ...
              className="inline-flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#1f2a40] bg-[#0b1326] max-lg:h-7 max-lg:w-7"
          ...
          <div className="relative z-20 shrink-0" ref={langMenuRef}>
            <button
              ...
              className="inline-flex h-8 cursor-pointer items-center gap-1 rounded-full border border-[#1f2a40] bg-[#0b1326] py-0.5 pl-1 pr-1.5 max-lg:h-7"
              title={
                language === "en" ? LANG_FLAG.en.label : LANG_FLAG.am.label
              }
            >
              <span className="inline-flex h-6 w-6 shrink-0 overflow-hidden rounded-full ring-1 ring-[#2a3754] max-lg:h-5 max-lg:w-5">
                <img
              ...
              <AppIcon
                ...
                size={12}
                strokeWidth={2.4}
                className={`shrink-0 text-[#8fa0c5] transition-transform ${langMenuOpen ? "rotate-180" : ""}`}
              />
            </button>
            ...
            {langMenuOpen ? (
              <ul
                ...
                className="absolute right-0 top-[calc(100%+6px)] z-50 min-w-[3.25rem] overflow-hidden rounded-xl border border-[#1f2a40] bg-[#0b1326] py-1 shadow-[0_12px_32px_-8px_rgba(0,0,0,0.55)] ring-1 ring-[#2a3754]/50"
              >
                <li role="none">
                  <button
                    type="button"
                  ...
                  >
                    <span className="inline-flex h-8 w-8 shrink-0 overflow-hidden rounded-full ring-2 ring-[#2a3754]">
                      <img
