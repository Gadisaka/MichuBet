...
function AgeRestrictionNotice({ variant = "inline", className = "" }) {
  ...
  if (variant === "badge") {
    return (
      <span
        className={`inline-flex h-7 min-w-7 items-center justify-center rounded-full border border-white/20 bg-[#111111] px-2 text-[11px] font-extrabold tracking-wide text-[#F6AF01] ${className}`.trim()}
