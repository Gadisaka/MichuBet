...
import bannerFour from "../../assets/banners/3.jpg";
...
function HeroBanner() {
  ...
  return (
    <div className="sb-card aspect-1080/300 w-full overflow-hidden rounded-[1.15rem] transition-shadow duration-500 hover:shadow-[0_20px_48px_-14px_rgba(246,175,1,0.12)]">
      <img
