...
```
Cashier browser (admin app at https://admin.michot.bet)
...
2. Run `Install-PrinterBridge.bat` (installs to `C:\Michotbet\PrinterBridge\`, restarts bridge).
...
- Ported from Sokasport `updatesdoc/printer-bridge-performance-fix.md`
