...
```bash
sudo mkdir -p /var/www/michubet-admin
rsync -avz --delete admin/dist/ user@your-vps:/var/www/michubet-admin/
```
...
sudo rsync -av --delete dist/ /var/www/michubet-admin/
```
...
Example:** `deploy/nginx/michubet-admin.example.conf`**

Install:

```bash
sudo cp /path/to/repo/deploy/nginx/michubet-admin.example.conf /etc/nginx/sites-available/michubet-admin.conf
sudo nano /etc/nginx/sites-available/michubet-admin.conf
sudo ln -sf /etc/nginx/sites-available/michubet-admin.conf /etc/nginx/sites-enabled/
...
| `deploy/nginx/michubet-admin.example.conf` | nginx template |
