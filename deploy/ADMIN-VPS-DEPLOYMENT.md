...
```bash
sudo mkdir -p /var/www/michotbet-admin
rsync -avz --delete admin/dist/ user@your-vps:/var/www/michotbet-admin/
```
...
sudo rsync -av --delete dist/ /var/www/michotbet-admin/
```
...
Example:** `deploy/nginx/michotbet-admin.example.conf`**

Install:

```bash
sudo cp /path/to/repo/deploy/nginx/michotbet-admin.example.conf /etc/nginx/sites-available/michotbet-admin.conf
sudo nano /etc/nginx/sites-available/michotbet-admin.conf
sudo ln -sf /etc/nginx/sites-available/michotbet-admin.conf /etc/nginx/sites-enabled/
...
| `deploy/nginx/michotbet-admin.example.conf` | nginx template                             |
