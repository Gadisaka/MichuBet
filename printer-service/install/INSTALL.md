# MichuBet PrinterBridge — Cashier Install Guide
...
After setup, open **https://admin.michot.bet** and tickets print silently. No WebUSB, Zadig, browser print dialog, or terminal.
...
- Copy files to `C:\MichuBet\PrinterBridge\`
...
1. Create folder: `C:\MichuBet\PrinterBridge\`
...
1. Copy `PrinterBridge-hidden.vbs` to `C:\MichuBet\PrinterBridge\`
...
2. Create a shortcut to `C:\MichuBet\PrinterBridge\PrinterBridge.exe`
